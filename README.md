...
- [@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react/blob/main/packages/plugin-react) uses [Babel](https://babeljs.io/) ( [oxc](https://oxc.rs) we used [oldown-vite](https://vite.dev/guide/rolldown)) 
